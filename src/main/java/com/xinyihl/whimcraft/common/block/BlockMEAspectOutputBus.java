...
import com.xinyihl.whimcraft.common.tile.TileMEAspectOutputBus;
...
public class BlockMEAspectOutputBus extends BlockMEBase {
    ...
    public TileEntity createTileEntity(World world, IBlockState iBlockState) {
        return new TileMEAspectOutputBus();
    }
    ...
    public boolean onBlockActivated(@Nonnull World world, @Nonnull BlockPos blockPos, @Nonnull IBlockState iBlockState, @Nonnull EntityPlayer entityPlayer, @Nonnull EnumHand enumHand, @Nonnull EnumFacing enumFacing, float v, float v1, float v2) {
        ...
        if (te instanceof TileMEAspectOutputBus && entityPlayer.isSneaking() && entityPlayer.getHeldItem(enumHand).isEmpty()) {
            if (world.isRemote) {
                ...
                ((TileMEAspectOutputBus) te).spillAll();
            }
            return true;
        }
    ...
    public Class<? extends TileEntity> getTileEntityClass() {
        return TileMEAspectOutputBus.class;
    }
}
