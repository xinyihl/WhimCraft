...
public class InfinityStorageItemCell extends AEBaseItem {
    ...
    protected void addCheckedInformation(ItemStack stack, World world, List<String> lines, ITooltipFlag advancedTooltips) {
        ...
        lines.add(new TextComponentTranslation("tooltip.whimcraft.infinity_storage_item_cell.stats", itemTypes, bytes).setStyle(new Style().setColor(TextFormatting.GRAY)).getFormattedText());
