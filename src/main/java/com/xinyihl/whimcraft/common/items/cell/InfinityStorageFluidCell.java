...
public class InfinityStorageFluidCell extends AEBaseItem {
    ...
    protected void addCheckedInformation(ItemStack stack, World world, List<String> lines, ITooltipFlag advancedTooltips) {
        ...
        lines.add(new TextComponentTranslation("tooltip.whimcraft.infinity_storage_fluid_cell.stats", fluidTypes, bytes).setStyle(new Style().setColor(TextFormatting.GRAY)).getFormattedText());
